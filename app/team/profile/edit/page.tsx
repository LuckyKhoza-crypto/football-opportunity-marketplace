...
export default function EditTeamProfilePage() {
  ...
  useEffect(() => {
    ...
    async function loadProfile() {
      try {
        ...
        const profile = teamProfile as TeamProfile;
        setFormData({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        let errorMessage = "Failed to update team profile";
        try {
          const errorData = await res.json();
          errorMessage = errorData.error || errorMessage;
        } catch {
        ...
        <Card className="w-full max-w-md text-center">
          <CardHeader>
            ...
            <CardDescription className="text-base">
              Your team profile has been updated successfully.
            </CardDescription>
          </CardHeader>
        </Card>
      </div>
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="mx-auto max-w-2xl">
        <div className="mb-8">
          <h1 className="mb-2 text-3xl font-bold">Edit Team Profile</h1>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Make changes to your team profile below.
            </CardDescription>
          </CardHeader>
