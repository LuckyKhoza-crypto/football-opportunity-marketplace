...
export const APPLICATION_STATUS_DESCRIPTIONS: Record<ApplicationStatus, string> = {
  pending: "Your application has been submitted and is waiting for the team to review it.",
  reviewing: "The team is currently reviewing your application.",
  accepted: "The team has accepted your application.",
  rejected: "The team has decided not to move forward with this application.",
